...
ARXIV_HEADERS = {
    "User-Agent": "top-paper-mcp-server/0.6.0 (https://github.com/doubletwo123/top-paper-mcp-server; research tool)"
}
    ...
    try:
        ...
        if base_query.strip():
            ...
            has_field_specifier = any(
                field in optimized_query for field in ["ti:", "au:", "abs:", "cat:"]
            )
