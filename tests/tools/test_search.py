...
from top_paper_mcp_server.tools import handle_search
from top_paper_mcp_server.tools.search import (
...
async def test_search_arxiv_error(mock_client):
    ...
    with patch(
        "top_paper_mcp_server.tools.search.get_arxiv_client", return_value=mock_client
    ):
...
async def test_search_client_page_size_matches_requested_max_results(
    ...
    from top_paper_mcp_server import config
...
async def test_search_no_query_optimization(mock_client):
    ...
    from top_paper_mcp_server.tools.search import _optimize_query
