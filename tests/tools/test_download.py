...
from top_paper_mcp_server.tools.download import (
    handle_download,
    get_paper_path,
    _html_to_text,
    _fetch_html_content,
...
async def test_cached_paper_returns_immediately(temp_storage_path, mocker):
    ...
    mock_httpx = mocker.patch("top_paper_mcp_server.tools.download._fetch_html_content")
    mock_pdf = mocker.patch("top_paper_mcp_server.tools.download._fetch_pdf_content")
...
async def test_html_endpoint_success(temp_storage_path, mocker):
    ...
    mocker.patch(
        "top_paper_mcp_server.tools.download._fetch_html_content",
...
async def test_html_404_falls_back_to_pdf(temp_storage_path, mocker):
    ...
    mocker.patch(
        "top_paper_mcp_server.tools.download._fetch_pdf_content",
